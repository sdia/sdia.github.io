...
var $author$project$Gen$Route$Advanced = {$: 'Advanced'};
var $author$project$Gen$Route$Dynamic__Name_ = function (a) {
	return {$: 'Dynamic__Name_', a: a};
};
...
var $author$project$Gen$Route$Static = {$: 'Static'};
...
var $author$project$Gen$Params$Advanced$parser = $elm$url$Url$Parser$s('advanced');
var $author$project$Gen$Params$Dynamic$Name_$Params = function (name) {
	return {name: name};
};
...
var $author$project$Gen$Params$Dynamic$Name_$parser = A2(
	$elm$url$Url$Parser$map,
	$author$project$Gen$Params$Dynamic$Name_$Params,
	A2(
		$elm$url$Url$Parser$slash,
		$elm$url$Url$Parser$s('dynamic'),
...
var $author$project$Gen$Params$Kubectl$parser = $elm$url$Url$Parser$s('kubectl');
var $author$project$Gen$Params$NotFound$parser = $elm$url$Url$Parser$s('not-found');
var $author$project$Gen$Params$Sandbox$parser = $elm$url$Url$Parser$s('sandbox');
var $author$project$Gen$Params$Static$parser = $elm$url$Url$Parser$s('static');
var $author$project$Gen$Route$routes = _List_fromArray(
	[
		...
		A2($elm$url$Url$Parser$map, $author$project$Gen$Route$Dynamic__Name_, $author$project$Gen$Params$Dynamic$Name_$parser)
	]);
...
var $author$project$Gen$Model$Advanced = F2(
	function (a, b) {
		return {$: 'Advanced', a: a, b: b};
	});
var $author$project$Gen$Msg$Advanced = function (a) {
	return {$: 'Advanced', a: a};
};
var $author$project$Gen$Model$Dynamic__Name_ = F2(
	function (a, b) {
		return {$: 'Dynamic__Name_', a: a, b: b};
	});
var $author$project$Gen$Msg$Dynamic__Name_ = function (a) {
	return {$: 'Dynamic__Name_', a: a};
};
var $author$project$Gen$Model$Element = F2(
	function (a, b) {
		return {$: 'Element', a: a, b: b};
	});
var $author$project$Gen$Msg$Element = function (a) {
	return {$: 'Element', a: a};
};
var $author$project$Gen$Model$Git = F2(
	function (a, b) {
		return {$: 'Git', a: a, b: b};
	});
...
var $author$project$Gen$Model$Kubectl = F2(
	function (a, b) {
		return {$: 'Kubectl', a: a, b: b};
	});
var $author$project$Gen$Msg$Kubectl = function (a) {
	return {$: 'Kubectl', a: a};
};
var $author$project$Gen$Model$NotFound = function (a) {
	return {$: 'NotFound', a: a};
};
var $author$project$Gen$Model$Sandbox = F2(
	function (a, b) {
		return {$: 'Sandbox', a: a, b: b};
	});
var $author$project$Gen$Msg$Sandbox = function (a) {
	return {$: 'Sandbox', a: a};
};
var $author$project$Gen$Model$Static = F2(
	function (a, b) {
		return {$: 'Static', a: a, b: b};
	});
var $author$project$Gen$Msg$Static = function (a) {
	return {$: 'Static', a: a};
};
...
var $author$project$View$none = {element: $mdgriffith$elm_ui$Element$none, title: ''};
...
var $author$project$Pages$Advanced$init = _Utils_Tuple2(
	{},
	$author$project$Effect$none);
var $author$project$Pages$Advanced$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$Pages$Advanced$update = F2(
	function (msg, model) {
...
var $author$project$UI$bodyFont = 24;
...
var $author$project$UI$layout = F2(
	function (titleNav, children) {
		var viewLink = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$Font$size($author$project$UI$bodyFont)
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$text(titleNav)
								])),
							A2(
							$mdgriffith$elm_ui$Element$column,
							_List_fromArray(
...
var $author$project$Pages$Advanced$view = function (model) {
	return {
		element: A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('Advanced')
						]))
				])),
		title: 'Advanced'
	};
};
var $author$project$Pages$Advanced$page = F2(
	function (shared, req) {
		return $author$project$Page$advanced(
			{init: $author$project$Pages$Advanced$init, subscriptions: $author$project$Pages$Advanced$subscriptions, update: $author$project$Pages$Advanced$update, view: $author$project$Pages$Advanced$view});
	});
...
var $author$project$UI$h1 = function (label) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_Nil,
		$mdgriffith$elm_ui$Element$text(label));
};
var $author$project$Pages$Dynamic$Name_$view = function (params) {
	return {
		element: A2(
			$author$project$UI$layout,
			'Dynamic: ' + params.name,
			_List_fromArray(
				[
					$author$project$UI$h1('Dynamic Page'),
					A2(
					$mdgriffith$elm_ui$Element$row,
					_List_Nil,
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text(params.name)
						]))
				])),
		title: 'Dynamic: ' + params.name
	};
};
var $author$project$Pages$Dynamic$Name_$page = F2(
	function (_v0, req) {
		return $author$project$Page$static(
			{
				view: $author$project$Pages$Dynamic$Name_$view(req.params)
			});
	});
...
var $author$project$Pages$Element$init = _Utils_Tuple2(
	{},
	$elm$core$Platform$Cmd$none);
var $author$project$Pages$Element$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$Pages$Element$update = F2(
	function (msg, model) {
		return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
	});
var $author$project$Pages$Element$view = function (model) {
	return {
		element: A2(
			$author$project$UI$layout,
			'Element',
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('Element')
						]))
				])),
		title: 'Element'
	};
};
var $author$project$Pages$Element$page = F2(
	function (shared, req) {
		return $author$project$Page$element(
			{init: $author$project$Pages$Element$init, subscriptions: $author$project$Pages$Element$subscriptions, update: $author$project$Pages$Element$update, view: $author$project$Pages$Element$view});
	});
var $author$project$Pages$Git$NewQuestion = function (a) {
	return {$: 'NewQuestion', a: a};
};
var $author$project$Pages$Git$NotCorrect = {$: 'NotCorrect'};
...
var $author$project$GitUtils$Question$Question = F3(
	function (question, hint, answers) {
		return {answers: answers, hint: hint, question: question};
	});
var $author$project$GitUtils$Question$dumbQuestion = A3(
	$author$project$GitUtils$Question$Question,
...
var $author$project$GitUtils$Question$questionGenerator = function (questions) {
	return A2($elm$random$Random$uniform, $author$project$GitUtils$Question$dumbQuestion, questions);
};
var $author$project$GitUtils$QuestionsBasic$questions = _List_fromArray(
	[
		A3(
		$author$project$GitUtils$Question$Question,
...
var $author$project$Pages$Git$init = function () {
	var model = {current_answer: '', current_answer_status: $author$project$Pages$Git$NotCorrect, feedback: '', next_question_enabled: false, question: $elm$core$Maybe$Nothing, show_solution: false};
	return _Utils_Tuple2(
		model,
		A2(
			$elm$random$Random$generate,
			$author$project$Pages$Git$NewQuestion,
			$author$project$GitUtils$Question$questionGenerator($author$project$GitUtils$QuestionsBasic$questions)));
}();
var $author$project$Pages$Git$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$Pages$Git$Correct = {$: 'Correct'};
...
var $author$project$Pages$Git$evaluate_answer = F2(
	function (model, answer) {
		var _v0 = model.question;
		if (_v0.$ === 'Just') {
			var question = _v0.a;
			return A2($elm$core$List$member, answer, question.answers) ? $author$project$Pages$Git$Correct : $author$project$Pages$Git$NotCorrect;
		} else {
			return $author$project$Pages$Git$NotCorrect;
		}
	});
var $author$project$Pages$Git$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Next':
				return _Utils_Tuple2(
			...
			case 'NewQuestion':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							current_answer: '',
							current_answer_status: $author$project$Pages$Git$NotCorrect,
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								...
								current_answer_status: A2($author$project$Pages$Git$evaluate_answer, model, answer)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
			...
			case 'ShowSolution':
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			default:
				return _Utils_eq(model.current_answer_status, $author$project$Pages$Git$Correct) ? _Utils_Tuple2(
					model,
					A2(
						$elm$random$Random$generate,
						$author$project$Pages$Git$NewQuestion,
						$author$project$GitUtils$Question$questionGenerator($author$project$GitUtils$QuestionsBasic$questions))) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Pages$Git$Answer = function (a) {
	return {$: 'Answer', a: a};
};
var $author$project$Pages$Git$Next = {$: 'Next'};
var $author$project$Pages$Git$ShowSolution = {$: 'ShowSolution'};
...
var $author$project$Pages$Git$capitalizeString = function (s) {
...
var $author$project$GitUtils$ColorSummer$red = A3($mdgriffith$elm_ui$Element$rgb255, 223, 82, 107);
...
var $author$project$GitUtils$ColorSummer$teal = A3($mdgriffith$elm_ui$Element$rgb255, 77, 188, 198);
var $author$project$Pages$Git$EnterWasPressed = {$: 'EnterWasPressed'};
...
var $author$project$GitUtils$ColorSummer$gray_dark = A3($mdgriffith$elm_ui$Element$rgb255, 124, 127, 135);
var $author$project$GitUtils$ColorSummer$gray_light = A3($mdgriffith$elm_ui$Element$rgb255, 186, 186, 186);
var $author$project$GitUtils$ColorSummer$green = A3($mdgriffith$elm_ui$Element$rgb255, 90, 167, 148);
...
var $author$project$Pages$Git$onEnter = function (msg) {
...
var $author$project$Pages$Git$track_progress_answer = F2(
...
var $author$project$Pages$Git$viewInput = F5(
	function (model, hint, current_answer, answers, toMsg) {
		var show_continue_message = _Utils_eq(model.current_answer_status, $author$project$Pages$Git$Correct) ? A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Font$color($author$project$GitUtils$ColorSummer$gray_light),
		...
		var show_alternative_answers = function () {
			if (_Utils_eq(model.current_answer_status, $author$project$Pages$Git$Correct)) {
								...
								A2(
									...
									function (o) {
										return A2(
											...
											_List_fromArray(
												[
													$mdgriffith$elm_ui$Element$Font$color($author$project$GitUtils$ColorSummer$teal)
												]),
											o);
									},
									A2(
		...
		var dStyle = function () {
			var answer_status = A2($author$project$Pages$Git$evaluate_answer, model, current_answer);
			if (answer_status.$ === 'Correct') {
				return $mdgriffith$elm_ui$Element$Font$color($author$project$GitUtils$ColorSummer$green);
			} else {
				return A2($author$project$Pages$Git$track_progress_answer, current_answer, answers) ? $mdgriffith$elm_ui$Element$Font$color($author$project$GitUtils$ColorSummer$gray_dark) : $mdgriffith$elm_ui$Element$Font$color($author$project$GitUtils$ColorSummer$red);
			}
		}();
		...
		return A2(
			...
			_List_fromArray(
				[
					dStyle,
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
					$author$project$Pages$Git$onEnter($author$project$Pages$Git$EnterWasPressed),
...
var $author$project$Pages$Git$bodyContent = function (model) {
	var _v0 = model.question;
	if (_v0.$ === 'Just') {
		var question = _v0.a;
		var make_button = F3(
		...
		var input_button_show_next = _Utils_eq(model.current_answer_status, $author$project$Pages$Git$Correct) ? A3(make_button, $author$project$Pages$Git$Next, 'next >', $author$project$GitUtils$ColorSummer$teal) : (model.show_solution ? A3(make_button, $author$project$Pages$Git$Next, 'next >', $author$project$GitUtils$ColorSummer$teal) : A3(make_button, $author$project$Pages$Git$ShowSolution, 'show', $author$project$GitUtils$ColorSummer$red));
		return A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
				[
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$mdgriffith$elm_ui$Element$text(
											$author$project$Pages$Git$capitalizeString(question.question))
										]))
								])),
							A2(
							$mdgriffith$elm_ui$Element$row,
							...
							_List_fromArray(
								[
									A5($author$project$Pages$Git$viewInput, model, question.hint, model.current_answer, question.answers, $author$project$Pages$Git$Answer),
...
var $author$project$Pages$Git$view = function (model) {
	...
	var element = A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Pages$Git$bodyContent(model)
					]))
			]));
	return {element: element, title: title};
};
var $author$project$Pages$Git$page = F2(
	function (shared, req) {
		return $author$project$Page$element(
...
var $author$project$Pages$Kubectl$page = F2(
	function (shared, req) {
		return $author$project$Page$element(
			{init: $author$project$Pages$Kubectl$init, subscriptions: $author$project$Pages$Kubectl$subscriptions, update: $author$project$Pages$Kubectl$update, view: $author$project$Pages$Kubectl$view});
	});
var $author$project$Pages$Sandbox$init = {};
...
var $author$project$Pages$Sandbox$update = F2(
	function (msg, model) {
		return model;
	});
var $author$project$Pages$Sandbox$view = function (model) {
	return {
		element: A2(
			$author$project$UI$layout,
			'Sandbox',
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text('Sandbox')
						]))
				])),
		title: 'Sandbox'
	};
};
var $author$project$Pages$Sandbox$page = F2(
	function (shared, req) {
		return $author$project$Page$sandbox(
			{init: $author$project$Pages$Sandbox$init, update: $author$project$Pages$Sandbox$update, view: $author$project$Pages$Sandbox$view});
	});
var $author$project$Pages$Static$view = {
	element: A2(
		$author$project$UI$layout,
		'Static',
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text('Static')
					]))
			])),
	title: 'Static'
};
var $author$project$Pages$Static$page = F2(
	function (shared, req) {
		return $author$project$Page$static(
			{view: $author$project$Pages$Static$view});
	});
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$alignLeft,
										$mdgriffith$elm_ui$Element$Font$size($author$project$UI$bodyFont * 3)
									]),
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$mdgriffith$elm_ui$Element$text('my name is Seydou, '),
												$mdgriffith$elm_ui$Element$text('I\'m a data engineer based in Berlin with 10 years of experience in helping '),
												$mdgriffith$elm_ui$Element$text('businesses get the most value from their data. I believe the main duty of a data '),
												$mdgriffith$elm_ui$Element$text('engineer is to reduce the cost of information access. I like to build simple and '),
												$mdgriffith$elm_ui$Element$text('scalable solutions to shorten the path to insights. On a personal level, I try '),
												$mdgriffith$elm_ui$Element$text('to be a good team player, to listen more, and to be prompt to admit the limits '),
												$mdgriffith$elm_ui$Element$text('of my knowledge. I love hiking, biking on my gravel and playing piano. My dream '),
												$mdgriffith$elm_ui$Element$text('is to work for a company aiming to improve the world. In 2021, my learning goals '),
												$mdgriffith$elm_ui$Element$text('focus on the topics of consensus and commit protocols in distributed systems '),
												$mdgriffith$elm_ui$Element$text('i.e. Paxos, Raft, Blockchain.')
											]))
									]))
							])),
						A2(
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$Font$size($author$project$UI$bodyFont * 4),
								$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
								$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill)
							]),
						_List_fromArray(
...
var $author$project$View$placeholder = function (pageName) {
	return {
		element: $mdgriffith$elm_ui$Element$text(pageName),
		title: pageName
	};
};
var $author$project$Pages$NotFound$view = $author$project$View$placeholder('Page not found.');
var $author$project$Gen$Pages$pages = {
	advanced: A3($author$project$Gen$Pages$bundle, $author$project$Pages$Advanced$page, $author$project$Gen$Model$Advanced, $author$project$Gen$Msg$Advanced),
	...
	sandbox: A3($author$project$Gen$Pages$bundle, $author$project$Pages$Sandbox$page, $author$project$Gen$Model$Sandbox, $author$project$Gen$Msg$Sandbox),
	_static: A3($author$project$Gen$Pages$bundle, $author$project$Pages$Static$page, $author$project$Gen$Model$Static, $author$project$Gen$Msg$Static)
};
var $author$project$Gen$Pages$init = function (route) {
	switch (route.$) {
		case 'Advanced':
			return $author$project$Gen$Pages$pages.advanced.init(_Utils_Tuple0);
		case 'Element':
		...
		case 'Kubectl':
			return $author$project$Gen$Pages$pages.kubectl.init(_Utils_Tuple0);
		case 'Sandbox':
			return $author$project$Gen$Pages$pages.sandbox.init(_Utils_Tuple0);
		case 'Static':
			return $author$project$Gen$Pages$pages._static.init(_Utils_Tuple0);
		case 'Dynamic__Name_':
			var params = route.a;
			return $author$project$Gen$Pages$pages.dynamic__name_.init(params);
		default:
...
var $author$project$Gen$Pages$subscriptions = function (model_) {
	switch (model_.$) {
		...
		case 'Advanced':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.advanced.subscriptions, params, model);
		case 'Element':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.element.subscriptions, params, model);
		case 'Git':
			var params = model_.a;
			var model = model_.b;
		...
		case 'Kubectl':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.kubectl.subscriptions, params, model);
		case 'Sandbox':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.sandbox.subscriptions, params, model);
		case 'Static':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages._static.subscriptions, params, model);
		case 'Dynamic__Name_':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.dynamic__name_.subscriptions, params, model);
		default:
			var params = model_.a;
...
var $author$project$View$toBrowserDocument = function (view) {
	return {
		body: _List_fromArray(
			[
				A2($mdgriffith$elm_ui$Element$layout, _List_Nil, view.element)
			]),
		title: view.title
	};
};
var $author$project$Gen$Pages$view = function (model_) {
	switch (model_.$) {
		...
		case 'Advanced':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.advanced.view, params, model);
		case 'Element':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.element.view, params, model);
		case 'Git':
			var params = model_.a;
			var model = model_.b;
		...
		case 'Kubectl':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.kubectl.view, params, model);
		case 'Sandbox':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.sandbox.view, params, model);
		case 'Static':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages._static.view, params, model);
		case 'Dynamic__Name_':
			var params = model_.a;
			var model = model_.b;
			return A2($author$project$Gen$Pages$pages.dynamic__name_.view, params, model);
		default:
			var params = model_.a;
